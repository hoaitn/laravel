                            ...
                            <table id="dataTable" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Activated: activate to sort column ascending">Activated</th>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{$user->name}}</td>
                                        <td>{{$user->email}}</td>
                                        <td><span class="label {{($user->verified == 1)?'label-success':'label-warning'}}">{{($user->verified == 1)?'Activated':'Pending'}}</span></td>
