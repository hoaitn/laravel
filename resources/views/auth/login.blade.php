...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="{{ asset('/statics/backend/plugins/iCheck/square/blue.css') }}" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <b>Adminitration Area</b>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">{{ Lang::get('backend/ui.auth_form_login_title_msg')  }}</p>
