                            ...
                            <table id="dataTable" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Created date: activate to sort column ascending">Created date</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td width="10%">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">                                                    
                                                    <li><a href="{{url('admin/content/edit',['id'=>$value->id])}}">Edit</a></li>
                                                    <li class="divider"></li>
