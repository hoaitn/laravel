                            ...
                            <table id="dataTable" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th rowspan="1" colspan="1">Title</th><th rowspan="1" colspan="1">Description</th><th rowspan="1" colspan="1">Detail</th><th rowspan="1" colspan="1">Created date</th><th rowspan="1" colspan="1">Modified date</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        <td>{{$value->id}}</td>
                                        <td>{{$value->Title}}</td><td>{{$value->Description}}</td><td>{{$value->Detail}}</td><td>{{$value->Created date}}</td><td>{{$value->Modified date}}</td>                                      
                                        <td width="10%">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">                                                    
                                                    <li><a href="{{url('admin/article/edit',['id'=>$value->id])}}">Edit</a></li>
                                                    <li class="divider"></li>
